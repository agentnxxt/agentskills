 ...
 */
export async function generateAdminToken(adminApiKey) {
    const [id, secret] = adminApiKey.split(":");
    if (!id || !secret) {
        throw new Error("Invalid Admin API key format. Expected format: id:secret (copy from Ghost Admin > Settings > Integrations)");
    }
